...
const file_service_one_proto_rawDesc = "" +
	...
	"\n" +
	"ServiceOne\x12?\n" +
	"\x05Hello\x12\x10.pb.HelloRequest\x1a\x11.pb.HelloResponse\"\x11\x82\xd3\xe4\x93\x02\v\x12\t/v1/helloB1Z/github.com/daniel-bss/havlabs/internal/apigw/pbb\x06proto3"

var (
	file_service_one_proto_rawDescOnce sync.Once
	file_service_one_proto_rawDescData []byte
)

func file_service_one_proto_rawDescGZIP() []byte {
	file_service_one_proto_rawDescOnce.Do(func() {
		file_service_one_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_service_one_proto_rawDesc), len(file_service_one_proto_rawDesc)))
	})
...
func file_service_one_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_service_one_proto_rawDesc), len(file_service_one_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
